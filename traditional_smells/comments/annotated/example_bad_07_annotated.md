...
- **Short explanation:** The function's conflict-detection logic, overbooking policy, and return contract are described exclusively through inline comments rather than the `@doc` attribute.
...
defmodule AppointmentScheduler do
  ...
  # VALIDATION: This is a smell because book_slot/3 is fully documented via plain

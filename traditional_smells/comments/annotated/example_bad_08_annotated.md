...
- **Smell name:** Comments
- **Expected smell location:** `RevenueReporter.generate_monthly_report/2`
- **Affected function(s):** `generate_monthly_report/2`
- **Short explanation:** The function's accepted options, output structure, and caching behaviour are all described with plain comments instead of `@doc`, bypassing Elixir's documentation system.
...
defmodule RevenueReporter do
  ...
  # VALIDATION: This is a smell because generate_monthly_report/2 is documented

...
- **Smell name:** Comments
- **Expected smell location:** `AuthService.issue_access_token/2`
- **Affected function(s):** `issue_access_token/2`
- **Short explanation:** The function relies entirely on block comments above its definition to explain its behavior, parameters, and return values, rather than using `@doc`. This prevents the documentation from being accessible via `IEx.h/1` or generated by ExDoc.
...
defmodule AuthService do
  ...
  # VALIDATION: This is a smell because the entire specification of issue_access_token/2

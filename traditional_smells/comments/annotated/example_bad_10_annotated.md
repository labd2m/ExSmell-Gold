...
- **Smell name:** Comments
- **Expected smell location:** `WebhookProcessor.process_event/2`
- **Affected function(s):** `process_event/2`
- **Short explanation:** The function's signature-verification step, idempotency guard, and event-routing table are documented using inline comments rather than `@doc`, making the documentation unreachable via standard Elixir tools.
...
defmodule WebhookProcessor do
  ...
  # VALIDATION: This is a smell because process_event/2 describes its entire

...
- **Short explanation:** The function's concurrency contract, side effects, and error cases are documented through inline explanatory comments rather than `@doc`, bypassing Elixir's standard documentation mechanism.
...
defmodule InventoryManager do
  ...
  # VALIDATION: This is a smell because reserve_stock/3 uses a long block of

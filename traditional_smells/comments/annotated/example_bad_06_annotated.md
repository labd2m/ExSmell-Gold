...
- **Smell name:** Comments
- **Expected smell location:** `PaymentGateway.charge_card/2`
- **Affected function(s):** `charge_card/2`
- **Short explanation:** The function uses explanatory inline comments to describe its parameters, retry logic, and return values instead of an `@doc` attribute, making the documentation hidden from Elixir tooling.
...
defmodule PaymentGateway do
  ...
  # VALIDATION: This is a smell because the complete contract of charge_card/2 —

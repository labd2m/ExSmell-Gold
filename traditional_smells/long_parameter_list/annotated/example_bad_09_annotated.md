# Annotated Example 09 — Long Parameter List

## Metadata

- **Smell name:** Long Parameter List
- **Expected smell location:** `UserManagement.Profiles.update_profile/13`
- **Affected function(s):** `update_profile/13`
- **Short explanation:** Thirteen positional parameters blend user identification, personal data, contact info, and account settings. Grouping related fields into a changeset or attrs map would dramatically reduce the risk of argument order errors.
...
defmodule UserManagement.Profiles do
  ...
  # VALIDATION: This is a smell because 13 positional parameters mix user identity,
  # VALIDATION: personal details, contact information, and UI/account preferences.
  # VALIDATION: The caller must remember the exact order of all 13 arguments,
  # VALIDATION: which is error-prone. A single attrs map or changeset would be cleaner.
  def update_profile(
        user_id,
        first_name,
        last_name,

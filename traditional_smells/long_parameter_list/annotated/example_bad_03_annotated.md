# Annotated Example 03 — Long Parameter List

## Metadata

- **Smell name:** Long Parameter List
- **Expected smell location:** `Accounts.Authentication.register_user/11`
- **Affected function(s):** `register_user/11`
- **Short explanation:** The function takes 11 individual parameters for user identity, profile, and preferences. This information could be cleanly grouped into a map or struct, avoiding the fragile positional argument list.
...
defmodule Accounts.Authentication do
  ...
  # VALIDATION: blending authentication credentials, profile data, and preferences
  # VALIDATION: into a single hard-to-use interface. A single attrs map or struct would be cleaner.
  def register_user(
        username,
        email,
        password,

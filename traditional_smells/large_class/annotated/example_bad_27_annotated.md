...
| **Expected smell location** | `CustomerRelations` module (entire module) |
| **Affected functions** | All functions: customer profile, segmentation, interaction history, loyalty points, and support tickets |
| **Short explanation** | `CustomerRelations` mixes customer profile management, behavioral segmentation, interaction timeline tracking, loyalty point accrual/redemption, and support ticket handling — five CRM sub-domains in a single non-cohesive module. |

```elixir
# VALIDATION: SMELL START - Large Module (Large Class)
# VALIDATION: This is a smell because CustomerRelations bundles customer
# profile management, segmentation logic, interaction logging, loyalty
# point accounting, and support ticket handling — each a separate CRM
# concern — into one large non-cohesive module.

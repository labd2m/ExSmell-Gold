...
| **Affected functions** | All functions: shipment creation, routing, carrier selection, customs, label generation, tracking, and delivery confirmation |
| **Short explanation** | `ShipmentCoordinator` contains logistics routing, carrier selection heuristics, customs documentation, label generation, shipment tracking, and delivery confirmation — six unrelated concerns in one module. |

```elixir
# VALIDATION: SMELL START - Large Module (Large Class)
# VALIDATION: This is a smell because ShipmentCoordinator mixes shipment
# creation, route optimization, carrier selection, customs docs, label
# generation, tracking, and delivery confirmation all in a single module,
# spanning entirely distinct business rules that should be separated.

...
| **Expected smell location** | `PatientCareManager` module (entire module) |
| **Affected functions** | All functions: patient registration, appointment booking, prescriptions, lab results, and billing |
| **Short explanation** | `PatientCareManager` handles patient registration, appointment scheduling, prescription management, lab result recording, and medical billing — five clinically and technically distinct sub-domains crammed into one module. |

```elixir
# VALIDATION: SMELL START - Large Module (Large Class)
# VALIDATION: This is a smell because PatientCareManager conflates patient
# registration, clinical appointment booking, prescription workflows,
# lab result management, and medical billing — all independent
# healthcare sub-domains — into a single non-cohesive module.

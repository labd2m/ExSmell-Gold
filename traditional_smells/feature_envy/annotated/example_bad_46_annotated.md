...
- **Smell:** Feature Envy
- **Expected smell location:** `Scheduling.ReminderDispatcher.build_reminder_payload/1`
- **Affected function(s):** `build_reminder_payload/1`
- **Explanation:** `build_reminder_payload/1` calls `Appointment.get_patient/1`, `Appointment.get_provider/1`, `Appointment.get_location/1`, `Appointment.cancellation_token/1`, `Appointment.reschedule_url/1`, and `Appointment.reminder_channels/1`, and reads multiple fields from the appointment struct. `ReminderDispatcher` contributes only channel-routing logic. The function envies `Appointment` and should live there.
...
defmodule Scheduling.ReminderDispatcher do
  ...
  # VALIDATION: This is a smell because build_reminder_payload/1 is defined in
  # VALIDATION: ReminderDispatcher but uses Appointment data almost exclusively.
  # VALIDATION: It calls:
  # VALIDATION:   - Appointment.get_patient/1
  # VALIDATION:   - Appointment.get_provider/1
  # VALIDATION:   - Appointment.get_location/1
  # VALIDATION:   - Appointment.cancellation_token/1
  # VALIDATION:   - Appointment.reschedule_url/1
  # VALIDATION:   - Appointment.reminder_channels/1
  # VALIDATION: and reads appointment.id, appointment.starts_at,
  # VALIDATION: appointment.duration_minutes, appointment.appointment_type,
  # VALIDATION: and appointment.notes directly from the struct.
  # VALIDATION: ReminderDispatcher only contributes URL construction and
  # VALIDATION: truncation helpers. This function should live in Appointment.

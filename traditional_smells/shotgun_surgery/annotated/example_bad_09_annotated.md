...
- **Expected Smell Location**: Functions `render_header/2`, `get_page_config/1`, `apply_branding/2`, and `get_cache_ttl/1` inside `Reports.Exporter`
- **Affected Functions**: `render_header/2`, `get_page_config/1`, `apply_branding/2`, `get_cache_ttl/1`
- **Explanation**: The export format logic (`:pdf`, `:csv`, `:xlsx`) is fragmented across four separate functions. Adding a new format (e.g., `:json`) forces four independent changes in different parts of the module, a hallmark of Shotgun Surgery.
...
defmodule Reports.Exporter do
  ...
  # VALIDATION: This is a smell because adding a new format (e.g., :json)
  # requires a new clause here AND in get_page_config/1, apply_branding/2,
  # and get_cache_ttl/1 — four scattered changes for one new format.
  ...
  # VALIDATION: This is a smell because a new format also requires a new page config
  # clause here, independently of the change in render_header/2.
  ...
  # VALIDATION: This is a smell because a new format also needs a new branding clause here,
  # independent of the previous two locations.
  ...
  # VALIDATION: This is a smell because a new format also requires a new cache TTL
  # clause here, completing the four-location change for every new format.
